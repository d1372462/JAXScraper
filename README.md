A simple, light-weight Java web crawler built on Jsoup and Xsoup with support for parallel processing, XPATH and predicates to do powerful web-scraping with minimal code.
